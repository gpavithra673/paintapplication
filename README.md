...
canvas{
    ...
    box-shadow: inset 0 0 5px #e2aaf3;
...
.newshape{
    ...
    border: 2px solid rgb(142, 154, 189);
    border-radius: 25px;
    color: rgb(12, 33, 90);
    padding: 15px 32px;
    text-align: center;
...
<body>
    ...
    <div class="container">
        ...
        <center>
            ...
            <button onclick="change_color(this)" id="cypher" style="background: rgb(243, 152, 33);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(154, 226, 38);"></button>
            ...
            <button onclick="change_color(this)" id="cypher" style="background: rgb(14, 20, 100);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(0, 0, 0);"></button>
        </center>
    </div>
    <br/>
    <center>
    <div class="footer">DEVELOPED BY G.PAVITHRA</div>
    </center>
    <script type="text/javascript">
